...
<table>
 <tbody>
  ...
  <tr>
   <td>入手方法</td>
   <td><p>はい。 SAP Commerce Cloud（AEM 6.4およびHybris 5 （デフォルト）をサポートするように更新され、Hybris 4との互換性を維持</p> <p>Salesforce Commerce Cloud（AEM 6.4 をサポートするためにオープンソース化されたコネクター）</p> </td>
