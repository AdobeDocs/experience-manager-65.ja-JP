...
AEM e コマースは、マーケターが web、モバイル、ソーシャルの各タッチポイントにまたがって、ブランド化され、カスタマイズされたショッピングエクスペリエンスを提供するのに役立ちます。AEMオーサリング環境を使用すると、ターゲット訪問者のコンテキストとマーチャンダイジング戦略に基づいて、ページとコンポーネントをカスタマイズできます。次に例を示します。
...
* **買い物客のデータとアクティビティに基づく、エクスペリエンス主導のコマース**&#x200B;を開発できる見込みがあります。これにより、次のような様々なシナリオに対応できます。

   * 1 つの例としては、合計注文金額が特定の金額を超えた場合に送料を下げることができます。
   * また、プロファイルデータ（場所など）を使用する季節限定のオファーを提供することもできます。 必要な場合は、その他の要因に応じて、再度これらのオファーをハイライト表示できます。
