...
>
>  
標準のAEMインストールには、[汎用のeコマース実装](/help/commerce/cif-classic/administering/generic.md)の基本が含まれています。
...
![ecommerproductvariant](/help/sites-administering/assets/ecommerceproductvariants.png)
...
![eコマース_カテゴリの実行](/help/sites-administering/assets/ecommerce_categoryrunning.png)
