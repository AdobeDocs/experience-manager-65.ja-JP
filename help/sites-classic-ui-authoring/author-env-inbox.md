...
1. 通知を受け取るページのパスを定義します。
   ...
   * 次をクリック： **パス** 表のセルにパスを入力し、例： `/content/docs`.
...
AEMインボックスで通知を受信することを選択した場合は、インボックスに通知が入ります。 以下が可能です。 [通知を表示](#viewing-your-notifications)次に、必要な通知を選択して、以下を実行します。
