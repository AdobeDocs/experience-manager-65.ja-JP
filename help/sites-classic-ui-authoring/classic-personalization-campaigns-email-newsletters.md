...
<table>
 <tbody>
  ...
  <tr>
   <td>電子メールの開封回数を追跡</td>
   <td>ExactTarget のトラッキング機能を使用できる非表示のコンポーネントです。<br /> </td>
  </tr>
 </tbody>
</table>
...
### テキストおよびパーソナライゼーションツールを E メールに追加する {#adding-text-and-personalization-tool-to-your-e-mail}

パーソナライズされたフィールドを E メールに追加するには、 **テキストとパーソナライゼーション** コンポーネントをページに配置します。
...
1. クリック **サービスを追加** in **Cloud Service** タブをクリックします。 サービスのリストが表示されます。 必要な設定を選択します（次のいずれか）。 **ExactTarget** または **Silverpop**  — をドロップダウンリストから選択します。
