...
新しいページを作成するときにページの&#x200B;**タイトル**&#x200B;のみを指定した場合、AEM ではページの&#x200B;**名前**&#x200B;がこの文字列から導き出され、AEM と JCR によって課された[規則に基づいてページ名が検証](/help/sites-developing/naming-conventions.md)されます。両方の UI とも、「**タイトル**」フィールドに無効な文字を含めることはできますが、派生した名前の無効な文字は別の文字に置き換えられます。次に例を示します。
