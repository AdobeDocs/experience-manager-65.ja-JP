...
ページに必要なプロパティを定義できます。これらは、ページの特性に応じて異なる場合があります。例えば、ライブコピーに接続されているページと接続されていないページがあり、ライブコピー情報は必要に応じて利用できます。
...
* **Cloud Services**
   ...
   [クラウドサービス](/help/sites-developing/extending-cloud-config.md)のプロパティを定義します。
...
* **ブループリント**
   ...
   [マルチサイト管理](/help/sites-administering/msm.md)でのブループリントページのプロパティを定義します。変更がライブコピーに反映される状況を制御します。

### ライブコピー {#live-copy}

* **ライブコピー**

   [マルチサイト管理](/help/sites-administering/msm.md)でのライブコピーページのプロパティを定義します。変更がブループリントから反映される状況を制御します。
