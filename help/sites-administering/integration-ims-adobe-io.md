...
## Adobe TargetとAEMの統合のためのAdobe I/Oの設定 {#configuring-adobe-i-o-for-adobe-target-integration-with-aem}
...
## Adobe I/O統合プロジェクト用に保存される詳細 {#details-stored-for-the-adobe-io-integration-project}
