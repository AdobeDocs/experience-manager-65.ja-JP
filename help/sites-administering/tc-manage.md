...
翻訳済みのソースページの[名前変更または移動](/help/sites-authoring/managing-pages.md#moving-or-renaming-a-page)が必要な場合、移動後にページを再度翻訳すると、新しいページ名／場所に基づいて新しい言語コピーが作成されます。以前の名前／場所に基づく古い言語コピーは、引き続き存在します。
