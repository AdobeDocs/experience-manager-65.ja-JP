...
ライブコピーは、 [通常のページ](/help/sites-administering/msm-livecopy.md#creating-a-live-copy-of-a-page) または [ブループリント設定](/help/sites-administering/msm-livecopy.md#creating-a-live-copy-of-a-site-from-a-blueprint-configuration). どちらも有効なユースケースです。
...
* サイトを作成するには、 [ブループリント設定](/help/sites-administering/msm-livecopy.md#managing-blueprint-configurations).
