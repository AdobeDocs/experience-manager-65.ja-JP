---
title: レポート
description: Adobe Experience Manager(AEM) でのレポートの操作方法について説明します。
...
レポートの新しいインスタンスは、 **ツール** コンソール。 選択 **レポート** 左側のウィンドウで、 **新規…** をクリックします。 を定義 **タイトル** および **名前**」で、必要なレポートタイプを選択して、 **作成**. 新しいレポートインスタンスがリストに表示されます。これをダブルクリックして開き、サイドキックからコンポーネントをドラッグすると、最初の列を作成してレポート定義を開始できます。
...
要件を選択して、「 **移動** をクリックして、レポートに適用します。 スナップショットをさらに作成した後にディスプレイを更新するには、をクリックします。 **移動** 再び
