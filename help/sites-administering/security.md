...
| プロパティ | メール情報、説明および名前情報を含めることができるユーザーまたはグループの情報が一覧表示されます。また、ユーザーのパスワードを変更できます。 [ユーザーとグループの作成](#creating-users-and-groups)、[ユーザーとグループのプロパティの変更](#modifying-user-and-group-properties)および[ユーザーパスワードの変更](#changing-a-user-password)を参照してください。 |
