...
AEM エクスペリエンスフラグメントは、Adobe Target のデフォルトワークスペースまたは Adobe Target のユーザー定義ワークスペースに書き出すことができます。 これは、Adobe Developerコンソールを使用しておこないます。この場合、AEMは [IMS を使用してAdobe Targetと統合](/help/sites-administering/integration-target-ims.md).
