...
description: AEM全体の様々なツールコンソールについて説明します。
...
>[!NOTE]
>
>UI のカードには各オプションの目的に関する詳細が表示されるので、この表では、ツリー内の機能の場所に関する簡単な参照を示します。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>ClientContext は、動的に組み立てられたユーザーデータのコレクションを表します。 デフォルトの Marketing Cloud 設定はここに保持されます。<br /> </td>
  </tr>
  <tr>
   <td>クラウドサービス設定<br /> </td>
   <td>Adobe Marketing Cloudとの統合に関連する設定を保持します。</td>
  </tr>
  <tr>
   <td>クラウド設定<br /> </td>
   <td>構成マネージャーの設定</td>
