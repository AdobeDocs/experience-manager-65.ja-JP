...
次のコード例は、 *Loan.psというPostScriptファイルを* Loan.pdfというPDFファイルに変 *換します*。 (PostScriptドキュメント [のPDFドキュメントへの変換を参照](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents))。
