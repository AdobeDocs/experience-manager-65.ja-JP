...
>[!NOTE]
>
>このプロセスは、AEM Forms の既存のプロセスに基づいたものではありません。このコードの例の流れを追うには、Workbench を使用して `MyApplication/EncryptDocument` という名前のプロセスを作成します。（[Workbench の使用](https://www.adobe.com/go/learn_aemforms_workbench_63_jp)を参照。）
