---
title: エンドポイントレジストリ Java&trade; API QuickStart(SOAP)
description: EJB、SOAP、監視フォルダー、電子メールエンドポイント、リモートエンドポイントなどのエンドポイントを追加し、Java&trade; API を使用してエンドポイントを編集、削除、取得する方法について説明します。
contentOwner: admin
...
[クイックスタート：Java を使用してリモートエンドポイントを追加する](endpoint-registry-java-api-quick.md#quickstart-adding-a-remoting-endpoint-using-the-java-api)
...
[QuickStart：Java を使用したエンドポイントの削除](endpoint-registry-java-api-quick.md#quickstart-removing-an-endpoint-using-the-java-api)
...
>[!NOTE]
>
>AEM forms によるプログラミングのクイックスタートは、UNIX®などの別のオペレーティングシステムを使用している場合は、Formsに基づいています。Windows 固有のパスを、該当するオペレーティングシステムでサポートされているパスに置き換えます。 同様に、別の J2EE アプリケーションサーバーを使用している場合は、有効な接続プロパティを指定する必要があります（[接続プロパティの設定](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)を参照）。
...
次の Java™コードの例では、EJB エンドポイントをという名前のサービスに追加します。 *MyApplication/EncryptDocument*. （[EJB エンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-ejb-endpoints)を参照）。
...
## QuickStart: Java™ API を使用した SOAP エンドポイントの追加 {#quickstart-adding-a-soap-endpoint-using-the-java-api}

次の Java™コードの例では、という名前のサービスに SOAP エンドポイントを追加します。 *MyApplication/EncryptDocument*. （[SOAP エンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-soap-endpoints)を参照）。
...
次の Java™コードの例では、監視フォルダーエンドポイントをという名前のサービスに追加します。 *MyApplication/EncryptDocument*. （[監視フォルダーエンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-watched-folder-endpoints)を参照）。

>[!NOTE]
>
次のクイックスタートをコンパイルして実行できるように、プロジェクトに WatchedFolderEndpointConfigConstants.java ファイルを含めます。 （[監視フォルダー設定値定数ファイル](/help/forms/developing/programmatically-endpoints.md#watched-folder-configuration-values-constant-file)を参照。）
...
次の Java™コードの例では、という名前のサービスに電子メールエンドポイントを追加します。 *MyApplication/EncryptDocument* t. ( [電子メールエンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-email-endpoints).)

>[!NOTE]
>
次のクイックスタートをコンパイルして実行できるように、プロジェクトに EmailEndpointConfigConstants.java ファイルを含めます。 （[メール設定値の定数ファイル](/help/forms/developing/programmatically-endpoints.md#email-configuration-values-constant-file)を参照。）
...
次の Java™コードの例では、リモートエンドポイントをという名前のサービスに追加します。 *MyApplication/EncryptDocument*. （[リモートエンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-remoting-endpoints)を参照）。
...
次の Java™コードの例では、TaskManager エンドポイントをという名前のサービスに追加します。 *MyApplication/EncryptDocument*. カテゴリ名は *EncryptProcess* です。（[TaskManager エンドポイントの追加](/help/forms/developing/programmatically-endpoints.md#adding-taskmanager-endpoints)を参照。）
...
## QuickStart: Java™ API を使用したエンドポイントの変更 {#quickstart-modifying-an-endpoint-using-the-java-api}

次の Java™コードの例では、監視フォルダーエンドポイントを変更しています。 エンドポイントは、 *MyApplication/EncryptDocument* プロセス。 監視フォルダーが `C:\NewWatchedFolder` に変更されます。（[エンドポイントの変更](/help/forms/developing/programmatically-endpoints.md#modifying-endpoints)を参照。）
...
次の Java™コードは、という名前のサービスから EJB エンドポイントを削除します。 *MyApplication/EncryptDocument*. （ [エンドポイントの削除](/help/forms/developing/programmatically-endpoints.md#removing-endpoints)を参照してください）。
...
## QuickStart: Java™ API を使用したエンドポイントコネクタ情報の取得 {#quickstart-retrieving-endpoint-connector-information-using-the-java-api}
