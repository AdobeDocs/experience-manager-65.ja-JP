...
Correspondence Managementは、データディクショナリの構造に従って格納されたバックエンド、顧客、または受信者固有のデータを使用して、様々な顧客向けの通信を作成します。 例えば、ドキュメントの作成時には「{First Name} さん」や「{姓}&quot;.
...
[互換性パッケージ](compatibility-package.md)をインストールして、**Forms**&#x200B;ページの&#x200B;**データディクショナリ**&#x200B;オプションを表示します。
