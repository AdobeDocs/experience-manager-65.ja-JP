...
AEM 6.5 SP23以降では、バンドル [com.adobe.granite.toggle.impl.dev](http://com.adobe.granite.toggle.impl.dev/)はForms アドオン AEM サービスパックと共に既にインストールされているため、インストールする必要はありません。
