...
>
>**client_idleTimeout:** ユーザーが特定の時間非アクティブのままになると、AEM Forms Workspaceのセッションは期限切れになります。この機能を有効にするには、「グローバル設定」にエントリを追加します。 &lt;client_idleTimeout>*IDLE_TIMEOUT_IN_SECONDS*&lt;/client_idleTimeout> 値0を指定すると、アイドルタイムアウトを無効にできます。 時間は秒単位で指定します。
