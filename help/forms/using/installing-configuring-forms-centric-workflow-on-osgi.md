...
>[!NOTE]
>
>OSGi 上の Forms 中心のワークフローにより、OSGi スタック上の様々なタスクに対するワークフローをすばやく作成してデプロイすることができます。完全な Process Management 機能を JEE スタックにインストールする必要はありません。機能の違いと類似点について詳しくは、OSGi上のForms中心のAEMワークフローとJEE上のProcess Managementの [](../../forms/using/capabilities-osgi-jee-workflows.md) 比較を参照してください。
>
