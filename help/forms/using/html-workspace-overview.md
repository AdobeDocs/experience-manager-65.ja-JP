...
同じタイプのタスクを複数承認できます。承認用に1つのタスクを選択すると、同じプロセスを持ち、同じタスク名を持ち、同じルートオプションを持つタスクのみが有効なままになります。 See [Working with To-Do lists](/help/forms/using/todo-lists.md) for implementation details.
