...
1. 既存のAEM インスタンスをAEM 6.5にアップグレードします。 手順は次のとおりです。
   ...
   1. AEM インスタンスをAEM 6.3にアップグレードします。 ステップバイステップの手順については、[AEM 6.5](/help/sites-deploying/upgrade.md)へのアップグレードを参照してください。
