...
1. 次の情報を指定します。
   ...
   * **[!UICONTROL タグ]**:（オプション）カスタムタグを作成するには、テキストフィールドに値を入力して、「Enter」を選択します。 この条件を保存すると、新しく追加されたタグが作成されます。
...
1. 条件に含める適切なアセットを選択し、「 」を選択します。 **[!UICONTROL 完了]**.
...
1. 選択 **[!UICONTROL ルールを作成]** ：必要に応じて、アセットの表示と非表示を切り替えるルールを追加します。 ルールで変数を使用するには、 [変数の作成](#variables). 詳しくは、[条件にルールを追加する](#ruleeditor)を参照してください。
...
1. 条件の作成または編集時に、「 ![ruleeditoricon](assets/ruleeditoricon.png) （ルールエディター）関連するアセットのアイコン。
...
1. 評価式、文字列、データモデルプロパティ、変数、または日付を挿入します。
   ...
   * ルールを作成または編集する際に、「 ![icon_resize](assets/icon_resize.png) （サイズ変更）をクリックして、[ ルールを作成/ルールを編集 ] ダイアログを展開します。 展開されたフルウィンドウダイアログでは、 [変数](#variables) を使用して、ルールを作成します。 もう一度「サイズ変更」を選択すると、通常の「ルールを作成」ダイアログに戻ります。
...
条件でルールを作成または編集する際に、 ![icon_resize](assets/icon_resize.png) （サイズ変更）をクリックして、[ ルールを作成\ルールを編集 ] ダイアログを展開します。 展開されたフルウィンドウダイアログでは、次の操作が可能です。
...
1. 条件でルールを作成または編集する際に、 ![icon_resize](assets/icon_resize.png) （サイズ変更）をクリックして、[ ルールを作成\ルールを編集 ] ダイアログを展開します。
