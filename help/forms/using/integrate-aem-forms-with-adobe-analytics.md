...
1. 「**[!UICONTROL prop]**」セクションで、ドロップダウンリストで選択可能なレポートスイートオプションを、[データ要素の設定](#configure-data-elements)で定義したデータ要素にマッピングします。
   ...
   1. Adobe Analytics の **[!UICONTROL Props]** 「 」セクションで、レポートスイートで使用可能なフォームタイトルの prop を選択し、「 」を選択します。 ![データベースアイコン](/help/forms/using/assets/database-icon.svg) を、 [データ要素の設定](#configure-data-elements).
...
1. Adobe Analytics の **[!UICONTROL 開発]** セクション、選択 ![その他のオプション](/help/forms/using/assets/more-options-icon.svg) 次に、「 **[!UICONTROL 承認して実稼動環境にパブリッシュ]**.
...
1. フィールドを選択し、「 」を選択します。 ![ルールエディター](/help/forms/using/assets/rule-editor-icon.svg) をクリックして、ルールエディターページを開きます。
...
1. 選択 ![製品を選択](/help/forms/using/assets/select-analytics.png) を選択し、 **[!UICONTROL Analytics]**.
...
1. 選択 ![ビジュアライゼーション](/help/forms/using/assets/visualization-icon.svg) をクリックし、「フリーフォーム」セクションにグラフタイプをドロップします。 同様に、複数のグラフタイプを「フリーフォーム」セクションに追加できます。
