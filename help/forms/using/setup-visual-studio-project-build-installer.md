...
1. [パッケージマネージャー](https://docs.adobe.com/content/help/ja/experience-manager-65/administering/contentmanagement/package-manager.html) を開き、 **[!UICONTROL パッケージをアップロード]** をクリックして、パッケージをアップロードします。
