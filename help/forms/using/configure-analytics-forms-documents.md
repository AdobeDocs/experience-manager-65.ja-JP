...
Adobe Analyticsを使用して、アダプティブフォーム、HTML5フォーム、およびインタラクティブな通信を使用する際に、ユーザーが直面するインタラクションパターンや問題を検出できます。 Adobe Analyticsは、初期設定で、次のパラメーターに関する情報を追跡して保存します。
...
1. Navigate to **Edit Settings** > **Conversion** > **Success Events**. 次の成功イベントを定義して有効にします。
