...
* フォームの平均記入時間が予想を上回る場合、フォームが複雑で顧客にとって理解しにくい、フォームで標準的な用語が使われていない、フォームが長すぎるなどの問題が考えられます。この場合、フォームの構造とフィールドの単純化、デザインの見直し、長さの短縮、または標準的でないフォームフィールドへのヘルプ文章や例示の追加などで対応することが考えられます。
