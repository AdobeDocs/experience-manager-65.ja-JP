...
* フォームの平均記入時間が予想よりも長い場合は、フォームが複雑で顧客にとって理解しにくく、フォームが標準の用語を使用していない、フォームが長すぎるなどの可能性があります。 この場合、フォームの構造とフィールドの単純化、デザインの見直し、長さの短縮、または標準的でないフォームフィールドへのヘルプ文章や例示の追加などで対応することが考えられます。
