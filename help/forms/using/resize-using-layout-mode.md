...
1. 新しいアダプティブフォームを作成するか、既存のアダプティブフォーム[を開きます。](../../forms/using/creating-adaptive-form.md)
...
### 新しいレスポンシブレイアウトを使用して、アダプティブフォームに古いフラグメントを埋め込む{#embed-an-old-fragment-in-an-adaptive-form-with-new-responsive-layout}
...
### 新しいレスポンシブレイアウトでフラグメントを古いアダプティブフォームに埋め込む{#embed-a-fragment-with-new-responsive-layout-in-an-old-adaptive-form}
