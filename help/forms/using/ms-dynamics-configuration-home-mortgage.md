...
AEM Formsは、Dynamics 365を[Formsデータ統合](/help/forms/using/data-integration.md)モジュールと統合するクラウドサービスを提供します。 Microsoft® Dynamicsで住宅ローンの申し込みに関するチュートリアルを使用する前に、Microsoft® Dynamics 365をWe.Financeリファレンスサイトで使用するように設定する必要があります。
