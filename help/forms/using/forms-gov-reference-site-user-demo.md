...
**この節**: CXリードは、古いPDFベースのフォームを紙ベースのプロセスの一部として使用しています。 最新化の一環として、SarahはこのPDFフォームを使用して新しい最新のアダプティブフォームを自動的に作成したいと考えています。
...
1. 次に、Camillaが自動フォームコンバージョンタスクを選択します
