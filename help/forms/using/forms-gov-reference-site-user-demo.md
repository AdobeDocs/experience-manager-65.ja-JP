...
1. 「**私は資格を持っていますか？**&quot; button.
1. 「**今すぐ適用**」ボタンをクリックして続行します。
...
1. *https://&lt;aemserver>:&lt;port>/content/we-gov/home.html* に移動します。
1. ナビゲーションバーで、「**オンラインサービス**&quot;.
1. 「ドラフトForms」パネルから、既存の「Enrollment Application For Health Benefits」を選択します。
...
1. *https://&lt;aemserver>:&lt;port>/aem/start.html* に移動します。
1. ユーザーアイコン（右上隅）をクリックし、**ログアウト**」、または「**次のユーザーとして動作**」メニューオプション（管理ユーザーと共に現在ログインしている場合）
   ...
   1. または別のユーザーとして実行：
      ...
      1. 「 」を入力&#x200B;**ジョージ**&quot;**次のユーザーとして動作**」フィールドに入力します。
...
1. ユーザーアイコン（右上隅）をクリックし、**ログアウト**」、または「**次のユーザーとして動作**」メニューオプション（管理ユーザーと共に現在ログインしている場合）
   ...
   1. または別のユーザーとして実行：
      ...
      1. 「 」を入力&#x200B;**カミラ**&quot;**次のユーザーとして動作**」フィールドに入力します。
...
1. 「**新しい申し込みを送信**「 」ボタンをクリックしてアダプティブフォームを開きます。
...
1. ページビューページに戻る（手順 3 でアクセス）と、「**リスト表示**&quot;.
1. 「**表示**&quot;ドロップダウンメニューで&quot;**リスト表示**&quot;.

   ![表示ドロップダウンメニューのリスト表示](/help/forms/using/assets/list_view_view_dropdown.jpg)

1. 同じメニューから、**設定を表示**」をクリックし、「**Analytics**」セクションに追加します。
...
1. 「**健康保険加入申込書**&quot;アダプティブフォームを選択し、&quot;**Analytics レポート**&quot;オプション。
