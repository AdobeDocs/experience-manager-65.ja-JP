...
1. 次の手順を実行して、選択した/条件付きのテキストがレターに表示されるかどうかを評価する条件を作成し、チェックマークをオンにして式を保存します。
   ...
   条件に挿入する DD 要素をダブル選択します。 適切な演算子を挿入し、ダイアログで次の条件を作成します。
   ...
   条件を挿入したら、条件の左側にあるハンドルの上にマウスポインターを置くと、条件が表示されます。 ハンドルを選択して、条件のポップアップメニューを表示できます。このメニューで、条件を編集または削除できます。
