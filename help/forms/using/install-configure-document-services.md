...
### Adobe Acrobat Pro DC のインストール {#install-adobe-acrobat-pro-dc}

PDF Generatorのサポート対象のAcrobat製品およびバージョンについては、JEE上のAEM Forms サポート対象プラットフォームの記事の「[PDF Generatorに関する考慮事項](aem-forms-jee-supported-platforms.md#software-support-for-pdf-generator)」を参照してください。 この節の手順では、**Adobe Acrobat Pro DC**&#x200B;の機能制限ライセンス （FRL）について説明します。
...
1. パッケージを選択して、「**[!UICONTROL インストール]**」をクリックします。
   ...
   [AEM Forms リリース](https://experienceleague.adobe.com/ja/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases)の記事に記載されている直接リンクからパッケージをダウンロードすることもできます。
