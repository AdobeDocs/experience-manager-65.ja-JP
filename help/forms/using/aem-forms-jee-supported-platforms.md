...
| -------------- | --------------- | ------------------- |
| MongoDB Enterprise 4.4 | Windows Server 2016（64 ビット） | Microsoft® Windows Server 2019（64 ビット） |
...
| Microsoft® Windows Server 2022（64 ビット） | Microsoft® SQL Server 2016 |  |
|  | JBoss® EAP 7.1.4 |  |
|  | My SQL JDBC connector 5.1.44 |  |
