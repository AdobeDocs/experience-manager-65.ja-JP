...
>- PDF Generatorでは、Acrobatを使用したネイティブコンバージョン用のAdobe Acrobat Pro DC （Continuous Track、最新バージョン）のサポート対象の32 ビット Windows ビルドと、Office ベースのコンバージョン用の32 ビット Microsoft® Office Professional Plus （Microsoft® Windows）が必要です。 機能制限ライセンス （FRL）またはAdobe エンタープライズ版デプロイメントプロセスを使用してAcrobatをアクティベートします。Document Services インストールの記事の[Adobe Acrobat Pro DC](install-configure-document-services.md#install-adobe-acrobat-pro-dc)のインストールを参照してください。
...
<tbody>
 ...
 <tr>
  <td>Adobe Acrobat Pro DC （Continuous Track、最新バージョン）</td>
  <td><a href="https://helpx.adobe.com/jp/acrobat/release-note/release-notes-acrobat-reader.html">AcrobatおよびReader リリースノート </a><br />に記載されている最新バージョン </td>
 </tr>
 </tbody>
</table>
...
>[!NOTE]
>
>Adobe Acrobat 2020 （クラシックトラック）は、AEM Formsではサポートされていません。 代わりに、Adobe Acrobat Pro DC （Continuous Track、最新バージョン）を使用してください。
>
...
| IBM® Content Manager クライアント 8.7 | IBM® Content Manager Client 8.5 | |
| Microsoft® Windows Terminal Server 2025 | | |


### リリース 6.5.24.0 （2025年11月26日）
