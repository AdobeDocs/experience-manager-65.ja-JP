...
次のカードを印刷（高解像度版をダウンロードするには[カード]をクリック）し、すばやい参照用に机の上に置いておくことができます。[ ![HTML5Formsのベストプラクティスクイックリファレンスカード](do-not-localize/best-practices_reference_card.png)](assets/html5_forms_best_practices_reference_card.pdf)
