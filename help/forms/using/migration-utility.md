...
[](../../forms/using/upgrade.md)AEM Forms6.4、6.3、または6.2からAEM Forms6.5の最新バージョンにアップグレードするか、新しいインストールを実行できます。 以前のインストール環境をアップグレードしたのか、新規インストールを実行したのかに応じて、以下に示すいずれかの手順を実行してください。
