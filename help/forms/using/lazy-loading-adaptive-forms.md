...
* 大きなフォームに対する遅延読み込みを設定するには、XFA ベースのアダプティブフォーム上で XSD スキーマベースのアダプティブフォームを使用します。 XFA ベースのアダプティブフォームにおける遅延読み込みの実装によるパフォーマンスの向上は、XSD ベースのアダプティブフォームでの向上に比べて、相対的に小さくなります。
