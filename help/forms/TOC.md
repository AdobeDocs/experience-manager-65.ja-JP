...
+ はじめに {#getting-started}
   ...
   + チュートリアル：最初のアダプティブフォームを作成する {#create-first-adaptive-form}
      ...
      + [チュートリアル：アダプティブフォームを発行する](/help/forms/using/publish-your-adaptive-form.md)
...
+ AEM Forms のインストールと設定 {#install-aem-forms}
   ...
   + OSGi での AEM Forms のインストール {#osgi-installation}
      + [OSGi でのAEM forms でサポートされるプラットフォーム](https://docs.adobe.com/content/help/en/experience-manager-65/deploying/introduction/technical-requirements.html)
   ...
   + JEE でのAEM Formsのインストール {#jee-installation}
      ...
      + [JEE 上のAEM Formsの自動インストールおよびデプロイ（JBoss 版）](http://www.adobe.com/go/learn_aemforms_installTurnkey_65)
      ...
      + [JEE 上のAdobe Experience Manager Formsのインストールおよびデプロイ（JBoss 版）](http://www.adobe.com/go/learn_aemforms_installJBoss_65)
      + [JEE 上のAdobe Experience Manager forms のインストールおよびデプロイ（WebSphere 版）](http://www.adobe.com/go/learn_aemforms_installWebSphere_65)
      + [JEE 上のAEM Formsのインストールおよびデプロイ（WebLogic 版）](http://www.adobe.com/go/learn_aemforms_installWebLogic_65)
      + [AEM Forms Workbench のインストール](using/install-workbench.md)
      + [ Designer のインストールと設定](using/installing-configuring-designer.md)
      + [AEM Forms（サーバークラスター）のインストールの準備](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_65)
      + [JBoss クラスターでの JEE 上のAdobe Experience Manager Formsの設定](http://www.adobe.com/go/learn_aemforms_clusterJBoss_65)
      + [WebSphere Cluster での JEE 上のAdobe Experience Manager Formsの設定](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
      + [WebLogic クラスターでの JEE 上のAdobe Experience Manager Formsの設定](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_65)
...
+ AEM Formsをアップグレード {#upgrade-aem-forms}
   ...
   + OSGi でのAEM Formsのアップグレード {#aem-forms-osgi-upgrade}
      + [OSGi でのAEM 6.5 Forms へのアップグレード](using/upgrade-forms-osgi.md)
   ...
   + JEE 上のAEM Formsのアップグレード {#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager Forms on JEE アップグレードのチェックリストと計画](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65_jp)
      + [JEE 上のAEM 6.5 Forms へのアップグレード](using/upgrade-forms-jee.md)
      + [JEE 上のAdobe Experience Manager Formsへのアップグレード（JBoss 版）](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65_jp)
      + [JEE 上の AEM Forms への自動アップグレード（JBoss 版）](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65_jp)
      + [JEE 上のAdobe Experience Manager Formsへのアップグレード（WebSphere 版）](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65_jp)
      + [JEE 上のAdobe Experience Manager Formsへのアップグレード（WebLogic 版）](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65_jp)
...
+ アダプティブフォーム - 高度なオーサリング {#adaptive-forms-advanced-authoring}
   ...
   + [アダプティブフォームまたはインタラクティブ通信をAEM Sitesシングルページアプリケーションに埋め込む](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ JEE 上のAEM Formsの管理者ヘルプ {#administrator-help}
   ...
   + Acrobat Reader DC Extensions の設定 {#configure-acrobat-reader-dc-extensions}
      ...
      + [期限切れのReader拡張サービス証明書を更新しています](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
...
+ 開発者向けリファレンス {#developer-reference}
   ...
   + JEE 上のAEM Formsを使用したプログラミング {#programming-aem-forms-jee}
      ...
      + AEM Forms向け SPI の開発 {#developing-spis-aem-forms}
         + [招待外部ユーザーハンドラーの作成](developing/creating-invite-external-users-handler.md)
      ...
      + レガシードキュメント {#legacy-documentation}
         + [JEE Workbench 上のAEM Formsの execute script サービスを使用した XML データの作成](developing/building-xml.md)
         + [JEE 上のAEM Forms Custom DSC を使用したファイルの圧縮と解凍](developing/compressing-decompressing-custom-dsc.md)
