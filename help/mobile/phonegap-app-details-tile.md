...
Content Update Server URL プロパティは、パブリッシュインスタンスを指す必要がある URL です。直接、または Dispatcher や CDN を通じて。 URL の形式は次のとおりです。
...
この **認証** 「 」タブを使用すると、アプリケーションに関連付ける OAuth クライアントを選択でき、開発者はAdobe Experience Managerの OAuth 認証を使用できます。
