---
title: アプリの詳細な構造
description: このページでは、/libs/mobileapps/components/angular/ng-page コンポーネント（ローカルサーバー上のCRXDE Lite）に基づいて、アプリ用に作成するページコンポーネントについて説明します。
contentOwner: User
...
アプリの解剖学について学習したら、[&#x200B; シングルページアプリケーション &#x200B;](/help/mobile/phonegap-single-page-applications.md)を参照してください。
