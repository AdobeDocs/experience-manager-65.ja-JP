...
>
>* 一部の機能はすべてのコンソールで使用できるわけではなく、一部のコンソールでしか使用できない追加機能もあります。個々のコンソールやその関連機能についての具体的な情報については、他のページで詳しく説明します。
...
<table>
 <tbody>
  ...
  <tr>
   <td>Sites</td>
   <td>サイトコンソールでは、AEM インスタンス上で実行される <a href="/help/sites-authoring/page-authoring.md">web サイトの作成、表示、管理</a>を行うことができます。このコンソールを通じて、web サイトのページの作成、編集、コピー、移動、削除や、ワークフローの開始、ページの公開を行うことができます。<br /> </td>
  </tr>
 </tbody>
</table>
...
コンテンツツリーのサイドパネルをリスト表示やカード表示と組み合わせると、プロジェクトの階層構造を簡単に確認し、コンテンツツリーのサイドパネルを使用してコンテンツ構造全体を簡単に移動でき、詳細なページ情報をリスト表示で確認できます。
...
タイムラインを使用すると、選択したリソースで発生したイベントを表示または開始することができます。「タイムライン」列を開くには、レールセレクターを使用します。
