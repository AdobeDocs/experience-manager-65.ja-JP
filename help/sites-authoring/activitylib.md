...
* **アクティビティのタイプ：**アクティビティのタイプ — A/Bテストまたはエクスペリエンスのターゲット設定
* **目的：**（オプション）アクティビティの説明。
...
1. アクティビティを作成するブランドをクリックまたはタップし、「****作成/**&#x200B;アクティビティを作成」をクリックまたはタップします。 **編集する場合は、マスター領域画面でアクティビティを選択し、「**アクティビティを編集**」をクリックまたはタップします。
