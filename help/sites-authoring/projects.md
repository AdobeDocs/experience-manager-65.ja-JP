...
>[!CAUTION]
>
>プロジェクトのユーザーが、プロジェクトの作成、タスク/ワークフローの作成、チームの表示と管理など、プロジェクト機能を使用して他のユーザー/グループを表示するには、**/home/users**&#x200B;と&#x200B;**/home/groups**&#x200B;に対する読み取りアクセス権が必要です。 これを実装する最も簡単な方法は、**projects-users**&#x200B;グループに&#x200B;**/home/users**&#x200B;と**/home/groups**への読み取りアクセス権を付与することです。
