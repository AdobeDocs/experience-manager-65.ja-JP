...
title: プロジェクト
seo-title: Projects
description: プロジェクトを使用すると、リソースを 1 つのエンティティにグループ化できます。このエンティティは、共通の共有環境を使用して、プロジェクトを簡単に管理できます。
...
タイムライン表示では、個々のプロジェクトを選択し、そのプロジェクトに関するアクティビティを表示できます。 パネルセレクターまたはホットキー `alt+1` を使用して、このビューに変更します。
...
The **E メール** タイルは、電子メールのリクエストを管理するのに役立ちます。 このタイルで、**メールをリクエスト**&#x200B;ワークフローを開始します。
