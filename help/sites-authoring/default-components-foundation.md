...
>[!CAUTION]
>
>この基盤コンポーネントは非推奨です。 Adobeは、 [画像コアコンポーネント](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/image.html?lang=ja) 代わりに、
...
>[!CAUTION]
>
>この基盤コンポーネントは非推奨です。 Adobeは、 [カルーセルコアコンポーネント](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/carousel.html?lang=ja) 代わりに、
...
>[!CAUTION]
>
>この基盤コンポーネントは非推奨です。 Adobeは、 [コンテンツフラグメントコアコンポーネント](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/content-fragment-component.html?lang=ja) 代わりに、
...
>[!CAUTION]
>
>この基盤コンポーネントは非推奨です。 Adobeは、 [テキストコアコンポーネント](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/text.html?lang=ja) 代わりに、
...
>[!CAUTION]
>
>この基盤コンポーネントは非推奨です。 Adobeは、 [画像](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/image.html?lang=ja) および [テキストコアコンポーネント](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/text.html?lang=ja) 代わりに、
