...
1. 「**現在のバージョンと比較**」を選択します。この [ページの差分](/help/sites-authoring/page-diff.md) が開き、違いが表示されます。
...
* **タイムワープは、公開されたページに基づいて機能します**  — タイムワープは、以前にページを公開した場合にのみ完全に機能します。 表示されない場合は、オーサー環境の現在のページが表示されます。
