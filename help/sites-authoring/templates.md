...
* [追加のプロパティの定義](#definingtemplatepropertiesauthor) （必要に応じて）テンプレート用
...
* [テンプレートの有効化](#enablingatemplateauthor) （ページの作成時に使用）
* Web サイトの必要なページまたはブランチのために[テンプレートを許可します。](#allowing-a-template-author)
* [テンプレートを公開](#publishingatemplateauthor) パブリッシュ環境で使用できるようにするには
...
1. [テンプレートを公開](#publishingatemplateauthor) から **テンプレート** コンソール。
