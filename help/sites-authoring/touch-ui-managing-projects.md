...
プロジェクトでは、リソースを 1 つのエンティティにグループ化して、全体として管理できます。 そのため、リソースをプロジェクトに関連付ける必要があります。 これらのリソースは、プロジェクト内で&#x200B;**タイル**&#x200B;としてグループ化されます。 追加できるリソースのタイプについては、[プロジェクトタイル](/help/sites-authoring/projects.md#project-tiles)で説明します。
...
デフォルトでは、コンソールにはアクティブなプロジェクトが表示されます。 「**アクティブなプロジェクトを切り替え**」アイコンを 1 回クリックすると、非アクティブなプロジェクトの表示に切り替わります。 もう一度クリックすると、アクティブなプロジェクトに切り替わります。
...
1. **プロジェクト** コンソールで、**作成**&#x200B;をクリックし、**フォルダーを作成**&#x200B;をクリックします。
...
プロジェクトが完了しても、プロジェクトに関する情報を保持する必要がある場合は、プロジェクトを非アクティブとしてマークすることができます。 [非アクティブなプロジェクト](#viewing-active-inactive-projects)が&#x200B;**プロジェクト**&#x200B;コンソールでデフォルトで表示されるようになりました。
...
プロジェクトによって自動的に作成されるグループについて詳しくは、[自動グループ作成](/help/sites-authoring/projects.md#auto-group-creation)を参照してください。
