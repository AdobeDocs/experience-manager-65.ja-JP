...
|   | **シンプルなプロジェクト** | **メディアプロジェクト** | **撮影した製品写真プロジェクト** | **翻訳プロジェクト** |
|---|:-:|:-:|:-:|:-:|
| コピーをリクエスト |  | x |  |  |
| 撮影した製品写真 |  | x | x |  |
| 撮影した製品写真（コマース） |  |  | x |  |
...
1. メディアプロジェクトで、右上にある下向きの山形をクリックします。 **ワークフロー** 並べて表示して選択 **ワークフローを開始**.
...
1. 単純なプロジェクトで、の右上にある下向きの山形をクリックします。 **ワークフロー** 並べて表示して選択 **ワークフローを開始**.
