...
1. **ターゲティングエンジン**&#x200B;ドロップダウンメニューで、ターゲティングエンジンを選択します。
   ...
   * AEM または Adobe Campaign 統合を使用していて、ターゲットコンテンツ（ニュースレター）を送信する場合は、「**Adobe Campaign**」を選択します。詳しくは、[ と Adobe Campaign の統合](/help/sites-administering/campaign.md)を参照してください。
