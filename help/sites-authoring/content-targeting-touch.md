...
![別のエクスペリエンスにマッピングされているオーディエンスにマッピングされた場合の警告シンボル](do-not-localize/chlimage_1-6.png)
...
ターゲット設定に ContextHub を使用する場合は、**ContextHub** をエンジンとして選択します。詳しくは、 [ContextHub の設定](/help/sites-developing/ch-configuring.md)
