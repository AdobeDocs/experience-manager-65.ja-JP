...
>
>すべてのAEMプロジェクトでは、[AEM Project Archetype](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=ja)を活用します。これは、ReactまたはAngularを使用するSPAプロジェクトをサポートし、SPA SDKを利用します。AEMのすべてのSPAプロジェクトは、SPA Starter Kit用のMavenアーキタイプに基づく必要があります。
