...
We.Retail では、HTL、レスポンシブレイアウト、編集可能なテンプレート、コアコンポーネントなど、最新のAEMテクノロジーを使用します。
...
| [コンテンツフラグメント](/help/assets/content-fragments/content-fragments.md) | We.Retail のエクスペリエンスの節では、コンテンツフラグメントを介してコンテンツを再利用する方法を示します。 | [試してみる](/help/sites-developing/we-retail-content-fragments.md) |
