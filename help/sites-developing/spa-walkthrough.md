...
* [The sample WKND SPA Project app available on GitHub](https://github.com/adobe/aem-guides-wknd-spa)
   * Download the [latest release of the React app.](https://github.com/adobe/aem-guides-wknd-spa/releases) 名前は `wknd-spa-react.all.classic-X.Y.Z-SNAPSHOT.zip` のようになります。
