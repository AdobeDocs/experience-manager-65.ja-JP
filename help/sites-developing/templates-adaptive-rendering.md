...
description: Adobe Experience Manager のアダプティブテンプレートレンダリングについて説明します。
contentOwner: User
...
>[!NOTE]
>
>デバイスグループ **レスポンシブデバイスにはセレクターがありません。これは、レスポンシブデザインに対応していると認識されるデバイスは、アダプティブなレイアウトを必要としないと見なされるからです。
