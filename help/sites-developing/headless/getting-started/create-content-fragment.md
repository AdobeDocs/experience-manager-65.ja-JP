...
1. AEMにログインし、メインメニューからを選択します。 **ナビゲーション/アセット**.
1. 以前に作成した [フォルダーに移動します。](create-assets-folder.md)
1. クリック **作成/コンテンツフラグメント**.
1. コンテンツフラグメントの作成は、2 つの手順でウィザードとして表示されます。最初に、コンテンツフラグメントの作成に使用するモデルを選択し、 **次へ**.
...
1. 次を提供： **タイトル**, **説明**、および **タグ** 必要に応じて、をクリックします。 **作成**.
