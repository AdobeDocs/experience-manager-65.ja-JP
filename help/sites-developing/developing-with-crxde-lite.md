...
1. AEM をインストールします。
1. ブラウザに`https://<host>:<port>/crx/de`と入力します。デフォルトは`https://localhost:4502/crx/de`です。
...
1. テンプレートの&#x200B;**ラベル**、**タイトル**、**説明**、**リソースタイプ**&#x200B;および&#x200B;**ランキング**&#x200B;を入力します。「**Next**」をクリックします。
...
1. コンポーネントの&#x200B;**ラベル**、**タイトル**、**説明**、**スーパーリソースタイプ**&#x200B;および&#x200B;**グループ**&#x200B;を入力します。「**Next**」をクリックします。

1. （オプション）コンポーネントのプロパティ（「**コンテナです**」、「**装飾なし**」、「**セル名**」、「**ダイアログパス**」）を設定します。「**Next**」をクリックします。

1. （オプション）コンポーネントのプロパティ「**許可されている親**」を設定します。「**Next**」をクリックします。
...
CRXDE Liteを使用すると、[CND(コンパクト名前空間とノード型の定義)表記](https://jackrabbit.apache.org/jcr/node-type-notation.html)でノード型の定義を読み込んだり書き出したりできます。
