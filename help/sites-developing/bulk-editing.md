...
>[!NOTE]
>
>一括編集はアセットに対しても使用できます。これは非常に似ていますが、いくつかの点で異なります。 詳しくは、 [複数のアセットのプロパティの編集](/help/assets/metadata.md) を参照してください。 アセットの一括メタデータエディターでフィールドをカスタマイズするには、 [スキーマエディター](/help/assets/metadata-schemas.md).
