...
2つのエンティティはルーティングの概念に関連していますが、は、現在のアプリケーションの状態と同期して構造化されたデータモデルを ` [ModelRouter](/help/sites-developing/spa-routing.md)`` [PageModelManager](/help/sites-developing/spa-blueprint.md#pagemodelmanager)` 読み込むことを単に行います。
