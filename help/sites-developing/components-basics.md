...
* **タッチ操作対応 UI**
   [標準のユーザーインターフェイス](/help/sites-developing/touch-ui-concepts.md) は、 [Coral UI](/help/sites-developing/touch-ui-concepts.md#coral-ui) および [](/help/sites-developing/touch-ui-concepts.md#granite-ui)Granite UIの基盤テクノロジーを使用して、Adobe Marketing Cloudの統合されたユーザーエクスペリエンスに基づいています。
