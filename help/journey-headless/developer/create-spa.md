...
* 可能な SPA 統合の様々なレベルを理解するには、](/help/sites-developing/headful-headless.md)AEM におけるヘッドフルとヘッドレス[のドキュメントを必ず確認してください。
...
* [サーバーサイドレンダリング](/help/sites-developing/spa-ssr.md) - AEM SPA への SSR の設定方法
