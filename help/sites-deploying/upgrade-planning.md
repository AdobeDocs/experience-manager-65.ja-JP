...
AEMバージョン6.0から6.5に直接アップグレードできます。5.6.x以下を使用するお客様は、まずバージョン6.0以降にアップグレードし、6.0(SP3)を推奨します。 また、6.3 以降は新しい OAK Segment Tar 形式がセグメントノードストアに対して使用されており、この新しい形式へのリポジトリ移行は 6.0、6.1 および 6.2 でも必須です。
