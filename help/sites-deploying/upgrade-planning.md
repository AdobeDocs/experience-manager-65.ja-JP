...
各お客様のAEMの実装は一意で、ビジネス要件に合わせてカスタマイズされています。 その結果、テスト計画に含めることができるように、システムに対して行われたすべてのカスタマイズを特定することが重要です。 このテスト計画は、アップグレードされたインスタンスに対してAdobeが実行する QA プロセスを強化します。
