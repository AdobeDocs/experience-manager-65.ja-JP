...
リポジトリが更新されるたびに、新しいコンテンツのリビジョンが作成されます。その結果、更新するたびに、リポジトリのサイズが大きくなります。 ディスクリソースを解放するには、古いリビジョンをクリーンアップする必要があります。これは、制御されないリポジトリの増加を防ぐために重要です。 このメンテナンス機能は、リビジョンクリーンアップと呼ばれます。AEM 6.0 以降では、この機能をオフラインルーチンとして使用できます。
