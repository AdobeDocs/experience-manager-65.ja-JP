...
>[!CAUTION]
>
>Segment ノードストアのPIDが、以前のバージョンのAEM 6のorg.apache.jackrabbit.oak.**plugins**.segment.SegmentNodeStoreServiceから、AEM 6.3のorg.apache.jackrabbit.oak.segment.SegmentNodeStoreServiceに変更されました。 変更が反映されるように、必要な設定を調整してください。
