...
* **AEM の request.log を使用した応答時間のモニタリング**
...
これらの検索リクエストは、プロジェクトの最初の時点から計画し、統合する必要があります。 モニタリングには次のメカニズムを使用できます。

* **AEM request.log を使用した検索応答時間のモニタリング**
...
* [インスタンスのモニタリングおよび保守](/help/sites-deploying/monitoring-and-maintaining.md)
...
| 何か | 何か | 何か | 何か | 何か |
|--- |--- |--- |--- |--- |
| `env` | `Env` （&quot;QA&quot; \| &quot;DEV&quot; \| &quot;DEV_443&quot; \| &quot;STAGE&quot; \| &quot;PROD&quot;） | いいえ | | 組み込みダイアログのデプロイメント環境。 指定しない場合は、現在のページのホスト名から推測されます。 |
