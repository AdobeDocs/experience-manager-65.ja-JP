...
| 参照を表示 | 削除 | サイト管理を使用して[詳細な参照リスト](/help/sites-authoring/author-environment-tools.md#references)を表示します。 |
| 監査ログ | 削除 | サイト管理を使用して[アクティビティレールを開きます](/help/sites-authoring/author-environment-tools.md#events-timeline)。 |
| バージョンを作成 | 削除 | サイト管理を使用して[バージョンを新規作成](/help/sites-authoring/working-with-page-versions.md#creating-a-new-version)します。 |
| バージョンの復元 | 削除 | サイト管理を使用して[バージョンを復元](/help/sites-authoring/working-with-page-versions.md#reverting-to-a-page-version)します。 |
| ローンチを切り替え | 削除 | サイト管理を使用して[ローンチを切り替え](/help/sites-authoring/launches-promoting.md)ます。 |
