---
title: リリースノート： [!DNL Adobe Experience Manager] 6.5.13.0
...
* アクセシビリティ - スクリーンリーダーに依存するユーザーが、フォーム内を移動する際に影響を受けます。NVDA が「幅と高さ」スピンコントロールのラベル情報を読み上げない場合、フォームコントロールに関する情報を理解するのが困難です。NVDA フォームモード「F」で移動する際に、レスポンシブ画像切り抜きヘッダーの下に存在するこれらのコントロール。 （ASSETS-5393）
