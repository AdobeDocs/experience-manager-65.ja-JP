...
* [Platform] commons-httpclient の metatype.xml ファイルの xmlns:metatype のバージョン番号は、「https://www.osgi.org/xmlns/metatype/v1.2.0」ではなく「https://www.osgi.org/xmlns/metatype/v1.0.0」です (NPR-37865)。
