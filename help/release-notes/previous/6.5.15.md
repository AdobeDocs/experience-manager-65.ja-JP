...
[!DNL Experience Manager] 6.5.15.0 には、2019年4月の初期の 6.5 公開以降にリリースされた新機能、お客様からの要望に基づく主要な機能強化、バグ修正、パフォーマンス、安定性、セキュリティの向上が含まれています。[このサービスパック](#install)を [!DNL Experience Manager] 6.5 にインストール<!-- UPDATE FOR EACH NEW RELEASE -->
...
* フィルターテキストには、背景色に比べて 4.5:1 の契約比率が不足しています。 （ASSETS-6873）
