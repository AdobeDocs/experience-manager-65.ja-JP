...
* AEM Forms サービスパック 19 （6.5.19.1）で、AEM Forms JEEの管理者UIの「サービス / PDF Generator / Adobe PDF設定」セクションに既存のJobOptions ファイルをアップロードすると、アップロードが失敗します。次のエラーメッセージも表示されます（FORMS-13597）。
...
* [!DNL Experience Manager] 6.5.21.0には[!DNL Experience Manager] 6.5が必要です。 詳しい手順については、[ アップグレードドキュメント ](/help/sites-deploying/upgrade.md)を参照してください。<!-- UPDATE FOR EACH NEW RELEASE -->
...
* [Experience Manager 6.5.21.0](/help/release-notes/assets/65210-bundles.zip)に含まれている OSGi バンドルのリスト<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.21.0](/help/release-notes/assets/65210-packages.zip)に含まれているコンテンツパッケージのリスト<!-- UPDATE FOR EACH NEW RELEASE -->
