...
[!DNL Adobe Experience Manager] 6.5.3.0 は、パフォーマンス、安定性、セキュリティ、お客様向けの主要な修正に加え、**2019 年 4 月** に 6.5 が一般リリースされた後にリリースされた機能拡張を含む重要なリリースです。 [!DNL Adobe Experience Manager] 6.5 上にインストールできます。
...
Experience Manager 6.5.3.0 の UberJar は、[Maven Central リポジトリー ](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.3/) で入手できます。
