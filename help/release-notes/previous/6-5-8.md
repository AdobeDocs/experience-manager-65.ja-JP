...
[!DNL Adobe Experience Manager] 6.5.8.0 [!DNL Assets] では、次の問題が修正され、次の機能強化が行われています。
...
* [!DNL Experience Manager] インスタンスを 6.5 から 6.5.8.0 バージョンにアップグレードする場合は、`RRD4JReporter` ファイル `error.log` 例外を表示できます。 インスタンスを再起動して問題を解決します。
