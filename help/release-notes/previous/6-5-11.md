...
* JEE 上のAEM Formsでは、キャッシュソリューションとして Apache Geode をサポートするようになりました。 現在AEM 6.5 Forms サービスパック 10 以前を使用している場合、Adobeは入手可能な最新のサービスパックにアップグレードすることをお勧めします。 これにより、Apache Geode をキャッシュソリューションとして最大限に活用できます。
