...
>[!CAUTION]
>
>「インデックス定義」パッケージの新しいバージョンが開発中です。 The link below will be published as soon as it is made available.
>
>Until then, you can also upgrade to 6.5.12.0 and contact Customer Care for the hotfix.
