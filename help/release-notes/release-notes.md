...
* [Experience Manager 6.5.25.0 に含まれている OSGi バンドルのリスト](/help/release-notes/assets/65250-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.25.0に含まれているコンテンツパッケージのリスト](/help/release-notes/assets/65250-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
