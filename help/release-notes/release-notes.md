...
* ホットフィックス 2 を使用したAEM Forms 6.5.23.0 で、（PDFG） PS からPDFおよびHTMLからPDF（WebKit）への変換に失敗します。 （FORMS-21721）

* ホットフィックス 3 が適用されたAEM Forms 6.5.23.0 で、（PDFG）画像をPDFに変換できない。 （FORMS-22029）
