...
* フランスのメンバーは、多国籍料理のWebサイトのコミュニティフォーラムに、フランス語でレシピを投稿します。
* 他の日本のメンバーは、翻訳機能を使って、フランス語から日本語へのレシピのトリガーを行っています。
* 日本語でレシピを読んだ後、日本のメンバーは日本語でコメントを投稿します。
