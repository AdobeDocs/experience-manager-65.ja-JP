...
audience: end-user
user-guide-title: AEM 6.5 Communities ユーザーガイド
...
+ AEM Communitiesの概要 {#introduction}
...
+ 管理 {#administer}
   ...
   + [Analyticsのコミュニティ機能の設定](analytics.md)
...
+ 開発 {#develop}
   ...
   + [ カレンダーの基本](calendar-basics-for-developers.md)
