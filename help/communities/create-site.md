...
>[!NOTE]
>
>[&#x200B; トンネルサービス &#x200B;](https://helpx.adobe.com/jp/experience-manager/6-3/help/communities/deploy-communities.html#tunnel-service-on-author)では、パブリッシュ環境でのみ存在するメンバーとグループを選択できます。
