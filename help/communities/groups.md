...
* AEM Communitiesでは、他のグループ内にグループをネストできます。 グループの入れ子は、新しいグループ](/help/communities/tools-groups.md)の[構造にグループ関数が含まれている場合に可能です。
...
>[!NOTE]
>
>このグループコンソールは、Communitiesのサイトコンソールからのみアクセス可能で、メンバーグループの管理に関するメンバー[グループコンソール](/help/communities/members.md)と混同しないでください。
>
...
* フォルダ内のコミュニティサイトのインスタンスを選択します。
   ...
   * これらのスクリーンショットは、publish](/help/communities/published-site.md)でグループを作成した後の「はじめに」チュートリアルに記載されています。[
...
* **コミュニティグループテン** プレートメニュー

   ドロップダウンを使用して、利用可能な[コミュニティグループテンプレート](/help/communities/tools.md)を選択します。
...
* **必要なメンバーシップ**
   ...
   選択した場合、コミュニティグループは開かれたグループになります。 コミュニティサイトのメンバーはグループのコンテンツを表示できますが、コンテンツを投稿するにはグループに参加する必要があります。 メンバーは、公開環境の`Join`ボタンを選択して参加します。 初期設定では選択されていません。

* **制限されたメンバーシップ**

   選択した場合、コミュニティグループは秘密のグループです。 コミュニティのメンバーは明示的に招待する必要があります。 招待メンバーは検索ボックスに入力されます。 [メンバーとグループコンソール](/help/communities/members.md)を使用して、作成者環境を後で追加できます。 初期設定では選択されていません。
