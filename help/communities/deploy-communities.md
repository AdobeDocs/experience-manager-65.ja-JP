...
バンドルのインストールに関する詳細は、 [Web コンソール](/help/sites-deploying/web-console.md) ページ。
...
* [cq-social-scorm-package，バージョン 2.3.7](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq640%2Fsocial%2Fscorm%2Fcq-social-scorm-2017-pkg) これには [SCORM 2017.1](https://rusticisoftware.com/blog/scorm-engine-2017-released/) エンジン。

**SCORM パッケージをインストールするには**

1. のインストール [cq-social-scorm-package，バージョン 2.3.7](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq640%2Fsocial%2Fscorm%2Fcq-social-scorm-2017-pkg)  を Package Share から削除します。
...
* 両方のエージェントで同じ手順を実行します。
   ...
   * **リバースレプリケーションエージェント（publish reverse）**
      ...
      1. 選択 **編集**
      1. を選択します。 **輸送** タブ
      1. ポートでない場合 `4503`、 **URI** 正しいポートを指定するには
...
* コピーする主要な素材を含むAEMインスタンス（通常はオーサーインスタンス）にアクセスします
   ...
   * を `com.adobe.granite.crypto.file` ローカル・ファイル・システム内のバンドル。例：
