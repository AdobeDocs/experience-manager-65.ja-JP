...
統合には、[Adobe Stock エンタープライズ版プラン](https://landing.adobe.com/en/na/products/creative-cloud/ctir-4625-stock-for-enterprise/index.html)と AEM 6.5 以降が必要です。AEM 6.5 サービスパックについて詳しくは、[リリースノート](/help/release-notes/sp-release-notes.md)を参照してください。
