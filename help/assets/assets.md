---
title: Adobe Experience Manager Assetsについて
description: デジタルアセット管理、その使用例、アドビのExperience Manager Assetの機能について説明します。
contentOwner: AG
...
アセットは、Experience Managerプラットフォームと完全に統合されたデジタルアセット管理(DAM)ツールで、デジタルアセットの共有と配布を企業で行うことができます。 組織のユーザーは、Web、印刷およびデジタル配信に使用する画像、ビデオ、ドキュメント、オーディオクリップ、リッチメディア（Flash ファイルなど）を管理、格納したり、これらのデジタルアセットにアクセスしたりできます。
...
### Experience Manager AssetsはExperience Manager Sitesと統合されています {#aem-assets-fully-integrated-in-cq-wcm}

アセットはサイトと完全に統合され、DAMアイコンを使用して機能を利用できます。 アセットリポジトリ内で管理されるデジタルアセットは、Webページの作成時に、コンテンツファインダーを介してアクセスできます。
...
>[!CAUTION]
>
>大量のアセット（特に画像）をアップロードまたは編集すると、Experience Managerインスタンスのパフォーマンスに影響を与える場合があります。

### Experience Manager Assetsの用語 {#aem-assets-terminology}
...
## Experience Manager AssetsとMediaLibrary {#cq-dam-vs-cq-medialibrary}
