...
[バリエーション](/help/assets/content-fragments.md#constituent-parts-of-a-content-fragment)は、特定のチャネルやシナリオで使用するためにマスターコンテンツのコピーを作成して編集できる、コンテンツフラグメントの重要な機能です。
...
* [テキストの要約](#summarizing-text)
* テキストへの[注釈](/help/assets/content-fragments-variations.md#annotating-a-content-fragment)の追加
...
>[!NOTE]
>
>詳しくは、[Markdown](/help/assets/content-fragments-markdown.md) の説明を参照してください。
...
* 選択されたフラグメントの[タイムライン](/help/assets/content-fragments-managing.md#timeline-for-content-fragments)で、注釈の表示や削除をおこなえます。
