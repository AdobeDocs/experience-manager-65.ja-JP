...
1. 販促物を編集するために開くには、次のいずれかの操作をおこないます。
   ...
   * 販促物を選択し、ツールバーの「**[!UICONTROL 編集]**」をクリックします。
   ...
   >[!NOTE]
   >
   >[!DNL Experience Manager] のデプロイメントを [!DNL InDesign Server] で統合して、[!DNL InDesign] テンプレートからデータを抽出し、編集で [!DNL Experience Manager Assets] るようにします。 詳しくは、[Experience Manager Assets と InDesign Server の統合](/help/assets/indesign.md)を参照してください。
