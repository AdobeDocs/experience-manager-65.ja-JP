...
1. 「**[!UICONTROL ライブコピーのソース]**」をクリックします。コンソールを開くには、「**[!UICONTROL ライブコピーの概要]**」をクリックします。このダッシュボードには、すべての子アセットの最上位ステータスが表示されます。
   ...
   *図：ライブコピーコンソールでのソースのライブコピーのステータスの表示*
...
![選択したソース図の参照レールで使用できるアクションと情報](assets/referencerail_source.png)*:選択したソースの参照レールで使用できるアクションと情報*

特定のライブコピーの場合は、「**[!UICONTROL ライブコピーを編集]**」をクリックすると、関係を休止したり、ロールアウト設定を変更したりできます。

![特定のライブコピーの場合、ソースアセットが選択されているときに、リレーションシップを中断するオプションまたはロールアウト設定を変更するオプションを参照レールからアク](assets/referencerail_editlc_options.png)*セスできます。特定のライブコピーの関係を中断するか、ロールアウト設定を変更する*
...
ライブコピーアセットまたはフォルダーを選択し、左側のレールを開いて「**[!UICONTROL 参照]**」をクリックします。あるいは、アセットまたはフォルダーを選択し、キーボードショートカット `Alt + 4` を使用します。

![選択したライブコピー図の参照レールで使用できるアクション](assets/referencerail_livecopy.png)*:選択したライブコピーの参照レールで使用できるアクション*
...
![選択したライブコピー図にソースの変更をロールアウト](assets/livecopy_rollout_dialog.png)*します。選択したライブコピーに対するソースの変更のロールアウト*
...
![同期アクションは、ソース図に対して行われた変更を取り込](assets/livecopy_sync.png)*みます。同期アクションは、ソースに対して行われた変更を取り込みます*
...
*図：リセット操作はローカルの編集を上書きし、ライブコピーをそのソースに移動します*
...
1. 「**[!UICONTROL ライブコピー]**」をクリックします。ツールバーの「**[!UICONTROL 分離]**」をクリックします。表示されるダイアログで「**[!UICONTROL 分離]**」クリックします。
   ...
   *図：デタッチアクションは、ソースとライブコピーの間の関係を完全に削除します*
