...
MSM for Assets を使用するには、少なくとも Service Pack 1 をインストールしてください。詳しくは、[リリースノート](/help/release-notes/sp-release-notes.md)を参照してください。
...
**再開：** ライブコピーが再度ソースから更新を受け取り始めるように、ライブ関係を再開します。 再開アクションを参照してください。
...
1. 「**[!UICONTROL ライブコピーのソース]**」をクリックします。コンソールを開くには、「**[!UICONTROL ライブコピーの概要]**」をクリックします。このダッシュボードには、すべての子アセットの最上位ステータスが表示されます。
   ...
   *図：ライブコピーのステータスをソースのライブコピーコンソールで表示*
...
![選択したソースの参照レールで使用可能なアクションと情報](assets/referencerail_source.png)
...
*図：特定のライブコピーの関係の中断またはロールアウト設定の変更*
...
1. 更新するライブコピーを選択します。「**[!UICONTROL ロールアウト]**」をクリックします。子アセットに対する更新内容をロールアウトするには、「**[!UICONTROL ソースとすべての子をロールアウト]**」をオンにします。
   ...
   *図：ソースの変更を数部またはすべてのライブコピーにロールアウト*
...
|---|---|---|
| [!UICONTROL 参照レール] | ソースが既に選択されているときにすばやく同期させます。 | [ソースの参照レールのクイックアクション](#refrailsource)を参照 |
...
1. 「**[!UICONTROL ライブコピー]**」をクリックします。ツールバーの「**[!UICONTROL 分離]**」をクリックします。表示されるダイアログで「**[!UICONTROL 分離]**」クリックします。
   ...
   *図：アタッチ解除アクションは、ソースとライブコピーの間の関係を完全に削除します*
...
1. このダッシュボードで、ライブコピーフォルダーからライブコピーアセットを選択します。ツールバーで目的のアクションをクリックします。使用可能なアクションは、**[!UICONTROL 同期]**、**[!UICONTROL リセット]**、**[!UICONTROL 休止]**、**[!UICONTROL 分離]**&#x200B;です。選択したソースフォルダーとライブ関係にある任意の数のライブコピーフォルダーに含まれている任意のアセットに対して、これらの操作をすばやく開始できます。
   ...
   *図：ライブコピーの概要コンソールから、ライブコピーフォルダー内の多数のアセットを簡単に更新できます。*

## MSM for Assets の拡張 {#extendapi}

AEM では、MSM Java API を使用して機能を拡張することができます。Assets の場合、拡張は MSM for Sites の場合と同じように機能します。詳しくは、[MSM の拡張](/help/sites-developing/extending-msm.md)を参照してください。具体的な作業については、以下を参照してください。
