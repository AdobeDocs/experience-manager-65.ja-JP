...
1. 「**[!UICONTROL タグ]**」フィールドで、タグを 1 つ以上選択します。カスタムタグを追加するには、ボックスにタグの名前を入力し、`Enter`を選択します。 新しいタグが [!DNL Experience Manager] に保存されます。[!DNL YouTube] は、公開するタグを必要とします。詳しくは、[YouTubeへのビデオの公開](video.md#publishing-videos-to-youtube)を参照してください。
