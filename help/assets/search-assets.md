...
*図：Experience Manager Assetsの検索結果インターフェイスについて理解します。*
...
*図：複数のキーワードを入力して、表示の提案をすべてに合わせて入力します。*
...
*図：フォルダーパネルにフォルダーパスを追加して、検索結果をフィルターーに制限します。*
...
*図：カード画像のオプションを使用して、類似した画像を検索します。表示*
...
*図：検索動作は引用符で囲まれた場合と引用符で囲まれなかった場合です。*
...
*図：例を使用したアセット検索でのアスタリスクワイルドカードの使用を示します。*
...
*図：例を使用したアセット検索での疑問符ワイルドカードの使用を示します。*
