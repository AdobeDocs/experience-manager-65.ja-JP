...
1. 「**[!UICONTROL 保存]**」をクリックします。この **[!UICONTROL スマートコレクションを編集]** ダイアログが表示されます。
...
1. **[!UICONTROL ダウンロード]**&#x200B;ダイアログで、「**[!UICONTROL ダウンロード]**」をクリックします。コレクション内のアセットのレンディションをダウンロードする場合は、「**[!UICONTROL レンディション]**」を選択します。を選択します。 **[!UICONTROL 電子メール]** オプションを使用して、コレクションの所有者に電子メール通知を送信します。
...
1. 「**[!UICONTROL 追加]**」をクリックします。コレクションが **[!UICONTROL 宛先を選択]** ページ。 メッセージを閉じて、プロセスを完了します。
