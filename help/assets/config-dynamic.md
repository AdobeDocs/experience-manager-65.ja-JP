...
ハイブリッドアドオンパッケージは、2025年5月22日木曜日（木）よりAdobe Software Distributionで公開され、AEM 6.5.23の正式リリースが開始されます。 ユーザーは、Software Distributionで&#x200B;**AEM 6.5 Dynamic Media ハイブリッドアドオンパッケージ**&#x200B;を検索して見つけることができます。
