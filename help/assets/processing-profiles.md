...
1. 「**[!UICONTROL 開始]**」をクリックした後、「**[!UICONTROL 確認]**」をクリックします。
   ...
   Experience Managerを監視したり、進行状況を確認したりするには、ワークフローのメインコンソールページで&#x200B;**[!UICONTROL ツール]**/**[!UICONTROL ワークフロー]**&#x200B;をクリックします。 ワークフローインスタンスページで、ワークフローを選択します。メニューバーの「**[!UICONTROL 履歴を開く]**」をクリックします。同じワークフローインスタンスページで、選択したワークフローの終了、休止、名前変更をおこなうこともできます。
