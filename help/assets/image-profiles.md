...
ダウンサンプリングされた最終的な画像に対するシャープフィルター効果を微調整するには、「**[!UICONTROL アンシャープマスク]**」を選択します。 効果の強さ、効果の半径（ピクセル単位）、無視されるコントラストのしきい値を制御できます。 このエフェクトでは、Adobe Photoshop の「*アンシャープマスク*」フィルターと同じオプションを使用します。
