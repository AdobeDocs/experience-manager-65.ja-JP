...
スピンセットのバナーには、「**[!UICONTROL SPINSET.]**」と表示されます。また、スピンセットが公開されている場合、公開日が&#x200B;**[!UICONTROL World]**&#x200B;アイコン付きでバナーに表示され、最終変更日も&#x200B;**[!UICONTROL 鉛筆]**&#x200B;アイコン付きで表示されます。
...
1. [スピンセットを発行します。](/help/assets/publishing-dynamicmedia-assets.md)
...
1. 次のいずれかの操作をおこないます。
   ...
   * スピンセットエディターページの左上隅付近にある「**[!UICONTROL アセットを追加]**」をタップします。

   * スピンセットエディターページの中央付近にある「**[!UICONTROL タップしてアセットセレクターを開きます。]**
