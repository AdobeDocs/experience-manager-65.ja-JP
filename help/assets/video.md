...
### Dynamic Media アカウントで DASH、マルチサブタイトル、マルチオーディオトラックのサポートを有効にする {#enable-dash}
...
アドビサポートケースを作成してアカウントで DASH を有効にすると同時に、マルチサブタイトルとマルチオーディオトラックのサポートが自動的に有効になるというメリットも得られます。有効にすると、以降にアップロードするすべてのビデオは、ビデオへのマルチサブタイトルおよびマルチオーディオトラックの追加をサポートする新しいバックエンドアーキテクチャで処理されるようになります。
...
**Dynamic Media アカウントで DASH、マルチサブタイトル、マルチオーディオトラックのサポートを有効にするには：**
...
1. サポートケースを作成するには、手順に従いながら次の情報を入力します。
   ...
   * Experience Manager 6.5 で、Dynamic Media アカウントで DASH、マルチサブタイトル、マルチオーディオトラックのサポートを有効にするように指定します。
...
すべての [Dynamic Media でサポートされるビデオ形式](/help/assets/assets-formats.md)およびすべての Dynamic Media ビデオビューア（Dynamic Media *Video_360* ビューアを除く）はマルチサブタイトルおよびマルチオーディオトラックでの使用がサポートされます。
