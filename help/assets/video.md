...
アドビのサポートケースを作成してアカウントで DASH を有効にすると同時に、複数のキャプションとオーディオトラックのサポートが自動的に有効になるというメリットも得られます。有効にすると、以降にアップロードするすべてのビデオは、新しいバックエンドアーキテクチャで処理されるようになります。このアーキテクチャには、ビデオへの複数のキャプションおよびオーディオトラックを追加するサポートが含まれます。
...
**Dynamic Media アカウントで DASH、複数のキャプションおよび複数のオーディオトラックのサポートを有効化するには：**
...
1. サポートケースを作成するには、手順に従いながら次の情報を入力します。
   ...
   * Experience Manager 6.5 の Dynamic Media アカウントで DASH、複数のキャプション、複数のオーディオトラックのサポートを有効化するように指定します。
...
すべての [Dynamic Media でサポートされるビデオ形式](/help/assets/assets-formats.md)およびすべての Dynamic Media ビデオビューア（Dynamic Media *Video_360* ビューアを除く）は、複数のキャプションおよびオーディオトラックでの使用がサポートされています。
