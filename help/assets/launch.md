...
拡張機能について詳しくは、Experience Platform Launch ユーザーガイドの[アドビ拡張機能](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/overview.html#adobe-extension)を参照してください。
...
この記述の時点では、*Dynamic Mediaビューア*&#x200B;の拡張は、開発用にAdobeの起動プロパティが作成されている場合にのみ使用できます。
