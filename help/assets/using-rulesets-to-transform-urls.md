...
* SEO（検索エンジン最適化）のための URL へのフォルダーパスの作成。
   ...
   [AdobeDynamic Media ClassicによるSEO](/help/assets/assets/s7_seo.pdf)のサポートを参照してください。
...
[ルールセット](https://helpx.adobe.com/jp/experience-manager/scene7/kb/base/scene7-rulesets/ruleset-asset-instead-image.html)で、「is」イメージの代わりに「asset」を使用するも参照してください。
...
1. 次の手順を実行して、ルールセットファイルをアップロードします。
   ...
   * ページ下部付近にある「**[!UICONTROL アップロード後に公開]**」がオンになっていることを確認します。
