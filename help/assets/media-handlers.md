...
* `https://www.imagemagick.org/script/index.php`と[Ghostscript](https://www.ghostscript.com/)を使用したEPSとAIの変換。
...
1. [!DNL ImageMagick]をインストール：`https://www.imagemagick.org/script/download.php` Web サイトを参照してください。
