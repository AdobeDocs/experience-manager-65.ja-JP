...
>* サービスパック 21 で Oauth 統合をサポートするには、[ ホットフィックス ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?pack[...]ackages/cq650/product/assets/cq-6.5.0-hotfix-40772-1.2.zip) をインストールする必要があります。
