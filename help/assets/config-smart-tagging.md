...
この記事では、スマートコンテンツサービスの設定に必要となる以下の主要なタスクについて詳しく説明します。バックエンドで、AEMサーバーは、要求をスマートコンテンツサービスに転送する前に、Adobe I/Oゲートウェイを使用してサービス資格情報を認証します。
...
1. Experience Managerで、ツール/ワークフ **[!UICONTROL ロー/モデルに移動します]**。
